                ...
                <div>
                    <div>
                        <form id="bootTableSearch" class="form-inline">
                            ...
                            <#--<label for="name">Name</label>-->
                                <input type="text" class="form-control" name="systemId" placeholder="查询业务系统编号">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="name" placeholder="查询角色名称">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="nameKey" placeholder="查询角色键名">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="btn-group hidden-xs" id="bootTableTool" role="group">
                        <button type="button" class="btn btn-outline btn-default"
                                onclick="BootstrapTableFunc.toAddForm('#bootTable','/admin/role/to_add.htm','role_1','新增角色',null)">
                            <i class="glyphicon glyphicon-plus" aria-hidden="true">新增</i>
                        </button>
                        <button type="button" class="btn btn-outline btn-default"
                                onclick="BootstrapTableFunc.toEditForm('#bootTable','/admin/role/to_update.htm','role_2','编辑角色')">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="javascript:void"
                                    onclick="BootstrapTableFunc.updateRows('#bootTable','/admin/role/batch_update_state.do',1)">启用</a>
                                </li>
                                <li><a href="javascript:void"
                                       onclick="BootstrapTableFunc.updateRows('#bootTable','/admin/role/batch_update_state.do',2)">禁用</a>
                                </li>
                                <li><a href="javascript:void"
                                       onclick="BootstrapTableFunc.updateRows('#bootTable','/admin/role/batch_update_state.do',0)">删除</a>
                                </li>
                            </ul>
                        </div>
                    </div>

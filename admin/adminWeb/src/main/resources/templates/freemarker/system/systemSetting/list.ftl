                ...
                <div>
                    <div>
                        <form id="bootTableSearch" class="form-inline">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="keyType" placeholder="查询键类型">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="keyName" placeholder="查询键名">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="keyValue" placeholder="查询键值">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="keyRemark" placeholder="查询键备注">
                            </div>
                    ...
                    <div class="btn-group hidden-xs" id="bootTableTool" role="group">
                        <button type="button" class="btn btn-outline btn-default"
                                onclick="BootstrapTableFunc.toAddForm('#bootTable','/admin/system/setting/to_add.htm','role_1','新增角色',null)">
                            <i class="glyphicon glyphicon-plus" aria-hidden="true">新增</i>
                        </button>
                        <button type="button" class="btn btn-outline btn-default"
                                onclick="BootstrapTableFunc.toEditForm('#bootTable','/admin/system/setting/to_update.htm','role_2','编辑角色')">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="javascript:void"
                                       onclick="BootstrapTableFunc.updateRows('#bootTable','/admin/system/setting/batch_update_state.do',1)">启用</a>
                                </li>
                                <li><a href="javascript:void"
                                       onclick="BootstrapTableFunc.updateRows('#bootTable','/admin/system/setting/batch_update_state.do',2)">禁用</a>
                                </li>
                                <li><a href="javascript:void"
                                       onclick="BootstrapTableFunc.updateRows('#bootTable','/admin/system/setting/batch_update_state.do',0)">删除</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<script src="/js/system/systemSetting/list.js"></script>
</body>
</html>